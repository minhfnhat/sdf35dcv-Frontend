        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              ...
              >
                Elevate Your Workday with Culinary Adventures
              </h2>
              <p
              ...
              >
                Discover a world of flavors delivered right to your office. Join our Food Tour and transform your lunch break into a gourmet experience.
              </p>
            </div>
            <dl
